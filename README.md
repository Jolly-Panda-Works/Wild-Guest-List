...
`js/ui/homeGameStart-ui.js` (tab switching). Play vs Bot's own page is
...
sourced from their Profile (`profile.html`) rather than being editable
in here — new players get a sensible default profile immediately, and
